...
void showEditVehicleDialog(BuildContext context, Vehicle vehicle,
  ...
  // Mensajes de error
  String errorMessage = '';
TextEditingController vehicleNameController = TextEditingController(text: vehicleNameInput);
TextEditingController consumptionController = TextEditingController(text: consumptionInput.toString());
  showDialog(
    context: context,
              ...
              ElevatedButton(
                onPressed: () async {
                  if (vehicleNameInput.isEmpty ||
                    ...
                    bool res = await onVehicleEdited(vehicle, vehicleNameInput,
                        consumptionInput);
                    if (!res) {
                      setDialogState(() {
                        errorMessage =
