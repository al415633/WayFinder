...
import 'package:WayFinder/model/userService.dart';
  ...
  group('R5: Gestión de preferencias', () {
   ...
   setUpAll(() async {
    ...
    test('H18-EI', () async {
      ...
      // Esto creo que deberia de hacerse de otra forma, con un metodo que te busque en el set un sitio en especifico
